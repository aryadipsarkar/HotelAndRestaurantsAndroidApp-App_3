...
public class MainActivityHotels extends AppCompatActivity implements HotelCommunicator {

    ImageFragmentHotels imageFragment = new ImageFragmentHotels();
    NameFragmentHotels nameFragment = new NameFragmentHotels();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_layout_hotels);
        // Get references to the NameFragment and to the TitleFragment
        nameFrame = (FrameLayout) findViewById(R.id.hotel_name_frame);
        imageFrame = (FrameLayout) findViewById(R.id.hotel_image_frame);
        ...
        fragmentTransaction.add(R.id.hotel_name_frame, nameFragment);
    ...
    public void respond(int i) {
        ...
        if (!imageFragment.isAdded()) {
            ...
            fragmentTransaction.add(R.id.hotel_image_frame, imageFragment);
